...
class GenericDBClass(object):
    """
    Stub of database class for ObjectListView 
    """
    pass 
...
class MainPanel(wx.Panel):
    def __init__(self, parent):
        ...
        loadDBBtn.Bind(wx.EVT_BUTTON, self.loadDatabased)
        self.table_names = []
    ...
    def loadTable(self, event):
        ...
        table = Table(current_table, metadata, autoload=True, aotoload_with=self.engine)
...
class MainFrame(wx.Frame):
    def __init__(self):
        super().__init__(
            parent=None, title="Database Viewer", size=(800, 600)
        )
